...
class SMSCaseController extends Controller{
    ...
    public function resendSMS (Request $req) {
        ...
        $urlsms = 'https://internalapi.clientname.id/sms/send';
            ...
            if (!empty($express_id)) {
                ...
                if (count($r) != 0 ) {
                    ...
                    if ($operator_id != '145b2728140f11e5bdbd0242ac110001'){
                        $urlsms = 'http://smsdev.clientname.id/sms/send/isentricmy';
                    ...
                    DB::table('tb_newlocker_generallog')
                            ->insert([
                                ...
                                'api_send_data' => json_encode(['express_id' => $express_id, 'expressNumber' => $expressNumber]),
